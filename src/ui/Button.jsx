...
function Button({ children, disabled, to, type, onClick }) {
  ...
  const style = {
    ...
    secondary: "font-semibold text-stone-700 hover:bg-stone-200 border-4 border-stone-200 transition-colors duration-300 tracking-wide uppercase rounded-full focus: outline-none focus:ring focus: ring-yellow-300 focus: ring-offset-2 py-2 px-4 md:px6 md:py-4 hover:text-stone-500"
  }
